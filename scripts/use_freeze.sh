...
# Source this file to enter the CUDA feature environment and remove BOP Mesa overrides.
# Usage:
#   source scripts/use_freeze.sh

if [[ "${BASH_SOURCE[0]}" == "$0" ]]; then
    echo "This script must be sourced: source scripts/use_freeze.sh" >&2
    exit 1
fi
...
conda activate freeze || return 1
...
echo "[FreezeV2-Re] environment: freeze"
